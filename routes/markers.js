...
module.exports = (db) => {
  ...
  router.post("/add/:id", (req, res) => {
    ...
    db.query(`INSERT INTO markers (title, description, image_url, user_id, map_id, latitude, longitude) VALUES($1, $2, $3, $4, $5, $6, $7);`, [title,description,image_url, userID ,mapID, latitude, longitude])
      .then(data => {
        const markers = data.rows;
        console.log(markers);
